...
- Solution URL: [Solution URL here](https://github.com/JulianLivrone/Product-preview-card-component)
- Live Site URL: [Live site URL here](https://julianlivrone.github.io/Product-preview-card-component/)
...
This was the perfect project for settling down the fundamentals of css and responsive layouts.

### Continued development

This was my first project since I started taking a web developer career more seriously, looking to improve my skills on HTML5 and CSS3 even further, more likely on Flexbox and CSS Grid.
